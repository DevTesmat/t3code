import {
  ...
  ThreadProposedPlanDeltaReceivedPayload as ContractsThreadProposedPlanDeltaReceivedPayloadSchema,
...
export const ThreadProposedPlanDeltaReceivedPayload =
  ContractsThreadProposedPlanDeltaReceivedPayloadSchema;
