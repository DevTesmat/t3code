...
export function normalizeKeybindingInput(keybinding: string | null | undefined): string | null {
...
export function decodeProjectScriptKeybindingRule(input: {
  ...
  const normalizedKey = normalizeKeybindingInput(input.keybinding);
...
export function buildKeybindingRule(input: {
  keybinding: string | null | undefined;
  command: KeybindingCommand;
  when?: string;
}): KeybindingRule | null {
