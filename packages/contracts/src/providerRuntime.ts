...
const RuntimeManagedFailure = Schema.Struct({
  ...
  expectedContentFound: Schema.optional(Schema.Boolean),
  attemptedPatch: Schema.optional(Schema.String),
  attemptedPatchEventId: Schema.optional(TrimmedNonEmptyStringSchema),
  attemptedPatchItemId: Schema.optional(TrimmedNonEmptyStringSchema),
  actualFileExists: Schema.optional(Schema.Boolean),
  actualFileHash: Schema.optional(TrimmedNonEmptyStringSchema),
  actualFileSizeBytes: Schema.optional(NonNegativeInt),
  actualFileLineCount: Schema.optional(NonNegativeInt),
  actualContentExcerpt: Schema.optional(Schema.String),
  actualContentExcerptStartLine: Schema.optional(NonNegativeInt),
  actualContentExcerptEndLine: Schema.optional(NonNegativeInt),
  actualContentExcerptTruncated: Schema.optional(Schema.Boolean),
  actualFileReadError: Schema.optional(TrimmedNonEmptyStringSchema),
